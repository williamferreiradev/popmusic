...
- [ ] Aplicar paginação no servidor em todas as listagens grandes (alunos concluído; RPC de resumo dos contratos preparado na migration 029; histórico e financeiro pendentes).
